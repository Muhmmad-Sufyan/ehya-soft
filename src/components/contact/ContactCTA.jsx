      ...
      <div className="rounded-2xl md:rounded-[3rem] p-8 md:p-12 lg:p-24 relative overflow-hidden group gradient-bg">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="/contact/#contact-form" className="bg-white text-primary px-10 py-5 rounded-full text-lg font-black hover:bg-slate-100 transition-all shadow-xl shadow-black/10 vibrant-shadow">
              Book a Consultation
            </Link>
