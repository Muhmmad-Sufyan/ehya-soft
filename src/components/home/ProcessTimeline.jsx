    ...
    <section className="py-12 md:py-24 bg-slate-50 relative overflow-hidden" id="process">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="lg:hidden absolute top-7 bottom-7 left-7 w-0.5 bg-slate-200"></div>
          <div className="grid lg:grid-cols-4 gap-6 lg:gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative flex items-center gap-4 lg:block lg:text-center">
                <div
