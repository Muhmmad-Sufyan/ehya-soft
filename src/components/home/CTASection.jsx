...
export default function CTASection() {
  return (
    <section className="py-12 md:py-24 px-4 bg-slate-50" id="quote">
      <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden relative bg-primary p-8 md:p-12 lg:p-20 text-center">
